...
<head>
	...
	<title>
	Se&aacute;n Halpin - a web designer &amp; developer - Error	</title>

	<!--
	
	Alright, you can look at this code - but only if you solve this maze within 10 seconds. 
	Fair is fair. Answers on a postcard, please.						
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-4">
						...
						<h1 id="header-logo-err" class="image-text">
						
							<a href="/">
								<img src="http://seanhalpin.io/assets/img/ui/404-icon.png" />
							</a>
					...
					<div class="col-md-8 col-xs-8">
						...
						<nav id="top-nav">
							...
							<ul class="nav-list transistion">
															...
															<li><a href="http://seanhalpin.io/">About</a></li>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="error--content">
								...
								<div class="error--block cloud--big-one"></div>
								<div class="error--block cloud--small-two"></div>
								<div class="error--block cloud--big-three"></div>
								<div class="error--block cloud--small-four"></div>
								
								<div class="error--block error--mobile-hide error--white-small-one"></div>
								<div class="error--block error--mobile-hide error--pink-big-two"></div>
								<div class="error--block error--green-big-three"></div>
								<div class="error--block error--mobile-hide error--white-small-four"></div>
								<div class="error--block error--mobile-hide error--white-big-five"></div>
								<div class="error--block error--mobile-hide error--pink-small-six"></div>
				...
				<div class="col-md-12">
					...
					<article>
						...
						<figure>
							...
							<img src="http://seanhalpin.io/assets/img/ui/404-me.png" />
						...
						<p class="info">
						How did you get here? Please return to player select and try again. Or head on <a href="/">home</a>, it's up to you.
						</p>
				...
				<div class="col-md-12">
					...
					<article>
						...
						<p class="btn-hldr">
							...
							<a href="@gmail.com||sean.e.halpin" class="main-btn email-lnk">message me <i class="email"></i></a>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<ul class="footer-list">
						...
						<li><a href="@gmail.com||sean.e.halpin" class="email-lnk">hire me</a></li>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<p>© 2019 <a href="http://seanhalpin.io">Sean Halpin</a>. All rights reserved.</p>
